...
exports.getFirebaseStoreAuthRouter = exports.getFirebaseStoreStrategy = void 0;
...
function getFirebaseStoreStrategy(id) {
    const strategyName = `${types_1.FIREBASE_STORE_STRATEGY_NAME}_${id}`;
    return class FirebaseStoreStrategy extends (0, Strategy_1.PassportStrategy)(passport_firebase_jwt_1.Strategy, strategyName) {
...
exports.getFirebaseStoreStrategy = getFirebaseStoreStrategy;
/**
 ...
 * @param configModule
 */
function getFirebaseStoreAuthRouter(id, firebase, configModule) {
    var _a;
    const strategyName = `${types_1.FIREBASE_STORE_STRATEGY_NAME}_${id}`;
