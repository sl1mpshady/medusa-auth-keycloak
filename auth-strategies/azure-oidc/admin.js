...
exports.getAzureAdminAuthRouter = exports.getAzureAdminStrategy = void 0;
 ...
 * @param id
 */
function getAzureAdminStrategy(id) {
    const strategyName = `${types_1.AZURE_ADMIN_STRATEGY_NAME}_${id}`;
...
exports.getAzureAdminStrategy = getAzureAdminStrategy;
/**
 ...
 * @param id
 */
function getAzureAdminAuthRouter(id, azure, configModule) {
    var _a, _b, _c;
    const strategyName = `${types_1.AZURE_ADMIN_STRATEGY_NAME}_${id}`;
