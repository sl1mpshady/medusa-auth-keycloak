...
export declare const OAUTH2_STORE_STRATEGY_NAME = "oauth2.store.medusa-auth-plugin";
export declare const OAUTH2_ADMIN_STRATEGY_NAME = "oauth2.admin.medusa-auth-plugin";
export type Profile = {
    emails: {
        value: string;
    }[];
