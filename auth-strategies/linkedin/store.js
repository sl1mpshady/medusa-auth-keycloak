...
exports.getLinkedinStoreAuthRouter = exports.getLinkedinStoreStrategy = void 0;
...
function getLinkedinStoreStrategy(id) {
    const strategyName = `${types_1.LINKEDIN_STORE_STRATEGY_NAME}_${id}`;
    return class LinkedinStoreStrategy extends (0, Strategy_1.PassportStrategy)(passport_linkedin_oauth2_1.Strategy, strategyName) {
...
exports.getLinkedinStoreStrategy = getLinkedinStoreStrategy;
/**
 ...
 * @param configModule
 */
function getLinkedinStoreAuthRouter(id, linkedin, configModule) {
    var _a, _b;
    const strategyName = `${types_1.LINKEDIN_STORE_STRATEGY_NAME}_${id}`;
