...
exports.getAuth0StoreAuthRouter = exports.getAuth0StoreStrategy = void 0;
...
function getAuth0StoreStrategy(id) {
    const strategyName = `${types_1.AUTH0_STORE_STRATEGY_NAME}_${id}`;
...
exports.getAuth0StoreStrategy = getAuth0StoreStrategy;
/**
 ...
 * @param configModule
 */
function getAuth0StoreAuthRouter(id, auth0, configModule) {
    var _a, _b;
    const strategyName = `${types_1.AUTH0_STORE_STRATEGY_NAME}_${id}`;
