...
exports.getAuth0AdminAuthRouter = exports.getAuth0AdminStrategy = void 0;
...
function getAuth0AdminStrategy(id) {
    const strategyName = `${types_1.AUTH0_ADMIN_STRATEGY_NAME}_${id}`;
    return class extends (0, Strategy_1.PassportStrategy)(passport_auth0_1.Strategy, strategyName) {
...
exports.getAuth0AdminStrategy = getAuth0AdminStrategy;
/**
 ...
 * @param configModule
 */
function getAuth0AdminAuthRouter(id, auth0, configModule) {
    var _a, _b;
    const strategyName = `${types_1.AUTH0_ADMIN_STRATEGY_NAME}_${id}`;
